    ...
    <div className="flex-1 p-4 md:p-8 max-w-7xl mx-auto w-full flex flex-col pt-20 md:pt-8 bg-slate-950 relative z-10">
      ...
      {isLoading ? (
        ...
        <>
          ...
          {heroBerita && (
            <Link href={`/berita/${heroBerita.id}`} className="relative w-full h-[350px] md:h-[375px] rounded-3xl overflow-hidden mb-8 group cursor-pointer border border-slate-800 shadow-xl block">
              <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-950"></div>
              <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/80 to-transparent"></div>

              <div className="absolute bottom-0 p-6 md:p-10 flex flex-col items-start">
