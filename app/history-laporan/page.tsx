...
import { Trash2, AlertCircle, Loader2, MapPin, Clock, FileText } from "lucide-react";
    ...
    <div className="flex-1 p-4 md:p-8 max-w-[1000px] mx-auto w-full flex flex-col pt-20 md:pt-8 bg-slate-950 relative z-10">
      <div className="mb-8 flex flex-col gap-2">
        <h1 className="text-3xl md:text-4xl font-black text-slate-100 tracking-tight flex items-center gap-3">
          <FileText className="w-8 h-8 text-teal-500" /> History Laporan
        </h1>
        <p className="text-slate-400">Kelola riwayat laporan kejadian yang telah Anda kirimkan.</p>
      </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-4 sm:p-6 lg:p-8">
        {loading ? (
          ...
          <div className="text-center py-12 flex flex-col items-center">
            ...
            <p className="text-slate-500 text-sm">Anda belum pernah mengirimkan laporan apa pun.</p>
          </div>
        ) : (
