...
export const JABODETABEK_AREAS: { name: string; geocodeQuery: string }[] = [
  ...
  {
    name: "Jakarta Pusat",
    geocodeQuery: "Jakarta Pusat, DKI Jakarta, Indonesia",
  },
  {
    name: "Jakarta Selatan",
    geocodeQuery: "Jakarta Selatan, DKI Jakarta, Indonesia",
  },
  {
    name: "Jakarta Timur",
    geocodeQuery: "Jakarta Timur, DKI Jakarta, Indonesia",
  },
  {
    name: "Jakarta Barat",
    geocodeQuery: "Jakarta Barat, DKI Jakarta, Indonesia",
  },
  {
    name: "Jakarta Utara",
    geocodeQuery: "Jakarta Utara, DKI Jakarta, Indonesia",
  },
  {
    name: "Tanah Abang",
    geocodeQuery: "Tanah Abang, Jakarta Pusat, Indonesia",
  },
  ...
  {
    name: "Pasar Minggu",
    geocodeQuery: "Pasar Minggu, Jakarta Selatan, Indonesia",
  },
  ...
  {
    name: "Kelapa Gading",
    geocodeQuery: "Kelapa Gading, Jakarta Utara, Indonesia",
  },
  ...
  {
    name: "Pondok Indah",
    geocodeQuery: "Pondok Indah, Jakarta Selatan, Indonesia",
  },
